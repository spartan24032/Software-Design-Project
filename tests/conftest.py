    ...
    with app.test_client() as testing_client:
        ...
        with app.app_context():
            """
				...
				The difference is that the code after yield will continue executing after the function calling this function finishes. 
			 	In this instance, it's so that functions calling test_client remain in the app_context()
			"""
